...
using KubernetesTaskConsumer.Services;
using Indubit.FlexTaskScheduler.KubernetesTaskConsumer;
    ...
    public static IHostBuilder CreateHostBuilder(string[] args) =>
        Host.CreateDefaultBuilder(args)
            .ConfigureServices((hostContext, services) =>
            {
                ...
                services.AddScoped<KubernetesHealthCheckProcessor>();
                services.AddScoped<KubernetesPodProcessor>();
                services.AddScoped<KubernetesNodeProcessor>();
